...
The [`encrypted.txt`](encrypted.txt) file looks like a simple cipher of some kind. Judging by the title, we can assume it is a substitution cipher... so let's try a few substitutions.

I don't have anything code written to do this kind of thing, but I know of an online tool that does the job. I threw it the encrypted text at [quipqiup.com], and out popped the flag.

__Submit: `awholenewworld`__
