...
To find a location of a function in memory, you can throw the program at [`objdump`][objeedump] and look through its [disassembly]. If you supply the `-D` option, [`objdump`][objeedump] will disassemble the supplied program. 

And of course if we want to find something, we can [`grep`][grep] for it.

![Screenshot](screenshot.png)

The top line will show the memory address of the function.

__Submit: `08048444`__
