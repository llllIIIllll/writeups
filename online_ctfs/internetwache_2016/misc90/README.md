...
Sam got this challenge during the actual competition, so all credit goes to him for the points, but I'll continue to crank out these writeups.

We were given [this zipfile](misc90.zip) to work with.

Once you extract the [zipfile](misc90.zip), you'll get this [`barcodes.jpg`](barcodes.jpg) file, which contains what looks like a bunch of cut up barcodes. 

For this challenge, you could seriously just move and crop all the barcodes by hand ( like in [GIMP] or something ) and then scan all the barcodes with your phone. Eventually, you'll get the flag. We didn't come up with any fancy technical solution to automate it... sorry!
