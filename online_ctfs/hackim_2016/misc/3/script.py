...
# http://gklokam.blogspot.com/2015/09/list-of-nicknames-of-indian-cities.html
# http://www.khichdionline.com/city-with-their-famous-nicknames-1/
...
"Gateway Of Karnataka",
"Coastal Paradise Of India",
"Chemical Capital Of India",
"Ice Cream City Of India",
"Rainy City Of India",
"City of Seven Islands",
"Financial Capital of India",
"Gateway of India",
...
for nickname in nicknames:
	...
	conn.recv()
	conn.sendline( nickname.lower() )
	success = conn.recv()
	if ( 'answer' in success ):

		print "GOT IT!", nickname.lower(), success
		raw_input()
	else:
		print "want", nickname.lower(), success
