__HackIM 2016 :: Programming Question 4__
==================================

_John Hammond_ | _Thursday, February 4th, 2016_ 
...
Oh, finally! Some real programming for this [CTF]!

If you hadn't known about it before, it would probably be pretty hard to decipher or even discover... but this challenge is referencing John Conway's [Game of Life]. I had learned about the [Game of Life] a while back, so I caught the hint and knew what to do.

The challenge prompt set up the problem for us. We're working in a 10x10 world and we need to work through 7 iterations. It gives us kind of a [binary] representation of the current state of the world; it is really just a mapping of which pixels are "alive" (1) and which are "dead" (0).

That was easy enough to program. Admittedly, though, [I ripped an algorithm off the internet](http://stackoverflow.com/questions/8484802/conways-game-of-life-with-python
) to follow through with the [Game of Life] rules. All I did was really set up the grid and tell it to run through 7 stages.

[Here is my final code](getflag.py):
...
The algorithm that I had found used [`numpy`][numpy] to handle the grid, so I just adapted my code a little bit to use it correctly.

The string that it prints out is the new grid after 7 iterations depicted the same way they had given us the initial grid in the challenge prompt. I was able to enter that as the flag, and finish up the programming challenges!

__The flag is `0000000000,0001100000,0001111010,0000001001,0000001010,0000000000,0000000000,0000000000,0000000000,0000000000`.__
