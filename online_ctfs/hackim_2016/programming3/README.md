__HackIM 2016 :: Programming Question 3__
==================================

_John Hammond_ | _Wednesday, February 3rd, 2016_ 
...
The solution I ended up finding for this wasn't really programming; it was more reconnaissance than anything else.

If I was looking for something on [Google+](https://plus.google.com/), I added that to my [Google] search. And it said it needed to have "a social home for each of our passions" in the result, so I added that quote to my search term as well.

All in all, all I had to really do was enter this into [Google]: `site:plus.google.com "a social home for each of our passions"`

The first result looked to be: 

```
Aug 16, 2015
https://plus.google.com/wm/capomaximo/+.../posts/EWMRJiG3Q5u
Aug 16, 2015 - Affimity is a social home for each of our passions - a single ... affimity.com. Affimity is a social home for each of our passions - a single place to ...
```

Hmm. Looks like "affimity.com". I tried to enter that as the flag, and hey -- I got it!

__The flag is `affimity.com`.__
