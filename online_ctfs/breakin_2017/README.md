...
The purpose of this directory and its sub-directories is to contain any information regarding challenges that we as a Cyber Team solved while participating in the online competition [BreakIn CTF 2017].
...
> Thu, 26 Jan. 2017, 15:30 UTC — Fri, 27 Jan. 2017, 15:30 UTC 
> On-line
> 
> A Break In event.
> 
...
I really really enjoyed this CTF. There were some clever challenges, but there were no real pwn or reverse engineering and the game was not listed on [CTFTime][CTFtime] (and that is probably why we did so well).

I led the charge on solving the challenges, but it was a really great learning experience for other members on the team because they were then able to practice and solve the challenges on their own. With some assistance from my Russian friend Abdelkader Belcaid, we managed to pull the 3rd place finish and "win" 2000 INR (about 30 US dollars). It was a hysterical victory. 


Challenges
----------

The following is a list of challenges that we successfully completed as part of the [BreakIn CTF 2017] competition.

__Note that bolded items have a solution added; regular entries _do not_.__

* [__Hello World__](hello_world/)
* [__A present for her Birthday!__](a_present_for_her_birthday/)
* [__Simple Secret - Part 1__](simple_secret_part_1/)
* [__Fast and Furious__](fast_and_furious/)
* Mysterious GIF
* Can you break the Feligma!
* [__Simple Secret - Part 2__](simple_secret_part_2/)
* [__A Dance Partner__](a_dance_partner/)
* [__Wild Card Entry!__](wild_card_entry/)
* [__A Weird C Program__](a_weird_c_program/)
* [__A lost birthday gift__](a_lost_birthday_gift/)
