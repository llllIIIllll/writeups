...
Oh, a networking challenge?

Well okay. That narrows the scope a bit. The challenge was odd because it didn't offer a link or file to download or anything... just an open-ended problem.

The real hint in the challenge prompt was the use of the phrase _"he is trying very hard to dig every place in search of his gift"_.

We have to use the `dig` command!

Again, with no real push in the right direction, I just kind of tried to use the competition domain. It just took some testing with it in different places to hunt down the flag.

First I tried just querying it...

```
dig -t any felicity.iiit.ac.in

; <<>> DiG 9.10.3-P4-Ubuntu <<>> -t any felicity.iiit.ac.in
;; global options: +cmd
;; Got answer:
...
;; QUESTION SECTION:
;felicity.iiit.ac.in.       IN  ANY

;; ANSWER SECTION:
felicity.iiit.ac.in.    119 IN  A   14.139.82.20
felicity.iiit.ac.in.    119 IN  MX  10 felicity.iiit.ac.in.
felicity.iiit.ac.in.    86399   IN  TXT "v=spf1 a mx include:_spf.google.com ~all"
felicity.iiit.ac.in.    86399   IN  TXT "google-site-verification=uUd1iZCodqCM_75wsY7-keY8V0YHZDbEy70MwQQLriM"

;; Query time: 297 msec
;; SERVER: 127.0.1.1#53(127.0.1.1)
;; WHEN: Mon Jan 30 07:46:33 EST 2017
;; MSG SIZE  rcvd: 214

```

I fell down the rabbit hole researching that `google-site-verification` thing for a while.

Eventually I tried treating that domain as the nameserver, too:

```
dig @felicity.iiit.ac.in -t any felicity.iiit.ac.in

; <<>> DiG 9.10.3-P4-Ubuntu <<>> @felicity.iiit.ac.in -t any felicity.iiit.ac.in
; (1 server found)
;; global options: +cmd
;; Got answer:
...
;; ANSWER SECTION:
felicity.iiit.ac.in.    0   IN  TXT "yougotit=the_flag_is_240bc306d1a19916d636f3d614e03024"

;; Query time: 276 msec
;; SERVER: 14.139.82.20#53(14.139.82.20)
;; WHEN: Mon Jan 30 07:47:38 EST 2017
;; MSG SIZE  rcvd: 114
```

... and boom, there it was.

__The flag was: `240bc306d1a19916d636f3d614e03024`__
